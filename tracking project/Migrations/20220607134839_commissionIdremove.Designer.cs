...
namespace tracking_project.Migrations
{
    ...
    [Migration("20220607134839_commissionIdremove")]
    partial class commissionIdremove
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tracking_project.Models.RFR", b =>
                {
                    ...
                    b.Property<int?>("CommissionCommisionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CommissionCommisionId");
            ...
            modelBuilder.Entity("tracking_project.Models.Comission", b =>
                {
                    ...
                    b.HasOne("tracking_project.Models.CustomerVehicle", "Vehicle")
                        .WithOne("Comission")
                        .HasForeignKey("tracking_project.Models.Comission", "VehicleId");
                });
            ...
            modelBuilder.Entity("tracking_project.Models.RFR", b =>
                {
                    b.HasOne("tracking_project.Models.Comission", "Commission")
                        .WithMany()
                        .HasForeignKey("CommissionCommisionId");
                });
